    ...
    <div>
        <el-form :model="form" label-width="100px">
            ...
            <el-form-item label="路线描述">
                <el-input type="textarea" v-model="form.route_description"></el-input>
            </el-form-item>
        </el-form>
        ...
        <el-button style="margin-top: 10px" @click="handleSave" :disabled="isSaveDisabled">保存</el-button>
    ...
    methods: {
        ...
        handleSave() {
            ...
            const routeData = {
                ...
                route_description: this.form.route_description,
                custom_lists: this.form.custom_lists  // 自定义列表数据
            };
            // 发送POST请求到后端API
            axios.post('http://localhost:8000/route/', routeData)
                .then(response => {
                    // 处理保存成功的情况
